...
const Nav = () => {
    ...
    return (
        <div className='z-20 flex fixed top-0 w-full items-start justify-between'>
            <div className='m-5 w-[6vw] '>

                <svg className='fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103 44">
            ...
            <div onMouseEnter={() => { navGreenRef.current.style.height = '100%' }}
                onMouseLeave={() => { navGreenRef.current.style.height = '0%' }} className='w-[16.5vw] bg-black relative h-[6.5vh] cursor-pointer'>

                <div className=' icons absolute z-50 top-[3vh] left-[7vw] flex flex-col items-end  gap-2'>
                    <div className='bg-white w-[6vw] h-[0.3vh]'></div>
                    <div className='bg-white w-[3vw] h-[0.3vh]'></div>
                </div>
                <div ref={navGreenRef} className='bg-red-500 transition-all absolute top-0 w-full h-[0%]'>
                </div>
